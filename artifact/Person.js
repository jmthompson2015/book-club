...
const Person = {
  ...
  properties: {
    ...
    chrisEvans: { first: "Chris", last: "Evans", wiki: "Chris_Evans_(actor)" },
    ...
    danielCraig: { first: "Daniel", last: "Craig", wiki: "Daniel_Craig" },
    danielSilva: {
      first: "Daniel",
      last: "Silva",
    ...
    davidSuchet: { first: "David", last: "Suchet", wiki: "David_Suchet" },
    ...
    hughFraser: { first: "Hugh", last: "Fraser", wiki: "Hugh_Fraser_(actor)" },
    jamesPatterson: {
      first: "James",
      last: "Patterson",
      wiki: "James_Patterson",
    },
    jamieHector: { first: "Jamie", last: "Hector", wiki: "Jamie_Hector" },
    ...
    marisaTomei: { first: "Marisa", last: "Tomei", wiki: "Marisa_Tomei" },
    ...
    penelopeCruz: { first: "Penélope", last: "Cruz", wiki: "Penélope_Cruz" },
    ...
    titusWelliver: { first: "Titus", last: "Welliver", wiki: "Titus_Welliver" },
