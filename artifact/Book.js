const Book = {
  ...
  properties: {
    ...
    "No Plan B": {
      title: "No Plan B",
      authorKeys: ["Lee Child", "Andrew Child"],
      series: [
        {
          key: "Jack Reacher",
          entry: "27",
    ...
    "Whatever Happened to Cathy Martin": {
      title: "Whatever Happened to Cathy Martin",
      authorKeys: ["Mim Eichmann"],
      meeting: "2023.09.25",
